...
app023.get('/:jobName023/:partId023', (req023, res023) => {
  var sql023 = "SELECT * FROM A2C WHERE job_name = '" + req023.params.jobName023 + "' AND part_id = " + req023.params.partId023 + " LIMIT 1";
...
app023.post('/', (req023, res023) => {
  ...
  var sql023 = "INSERT INTO A2C VALUES('" + req023.body.jobName023 + "', " + req023.body.partId023 + ", " + req023.body.qty023 + ")";
...
app023.put('/', (req023, res023) => {
  ...
  var sql023 = "UPDATE A2C SET quantity = " + req023.body.qty023 + " WHERE job_name = '" + req023.body.jobName023 + "' AND part_id = " + req023.body.partId023;
